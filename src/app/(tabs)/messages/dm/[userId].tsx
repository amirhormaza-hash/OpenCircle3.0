...
const styles = StyleSheet.create({
  ...
  headerName:   { fontSize: 15, fontWeight: '700', color: '#F0F0FA' },
  headerUsername: { fontSize: 12, color: '#7878A0', fontWeight: '500' },
  messageList: { paddingHorizontal: 14, paddingTop: 12, paddingBottom: 8, flexGrow: 1 },
  timestamp:   { fontSize: 11, color: '#5A5A78', textAlign: 'center', marginVertical: 10 },
  ...
  bubbleMe:    { backgroundColor: '#FF6B00', borderBottomRightRadius: 4 },
  bubbleThem:  { backgroundColor: '#1E1E28', borderBottomLeftRadius: 4 },
  bubbleText:  { fontSize: 15, lineHeight: 20 },
  bubbleTextMe: { color: '#fff' },
  bubbleTextThem: { color: '#F0F0FA' },
  emptyWrap:   { flex: 1, alignItems: 'center', justifyContent: 'center', paddingTop: 80, gap: 10 },
  emptyText:   { fontSize: 14, color: '#5A5A78', fontWeight: '500' },
  inputRow: {
  ...
  input: {
    ...
    color: '#F0F0FA', fontSize: 15, borderWidth: 1, borderColor: '#2E2E40',
  },
  ...
  sheetTitle: { fontSize: 17, fontWeight: '800', color: '#F0F0FA', marginBottom: 12 },
  ...
  reportUserText: { fontSize: 15, fontWeight: '600', color: '#E05A5A' },
